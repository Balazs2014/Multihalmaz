...
public class Multiset<T>{
    ...
    public boolean isEqual(Multiset<T> masikHalmaz){
        boolean equals = true;
    ...
    public boolean isPartOf(Multiset<T> masikHalmaz){
        boolean partOf = true;
        for(int i = 0; i < elemLista.size(); i++){
            if (!masikHalmaz.isElement(elemLista.get(i))){
                partOf = false;
    ...
    public Multiset<T> unio(Multiset<T> masikHalmaz){
        Multiset<T> unio = new Multiset<>();
    ...
    public Multiset<T> intersection(Multiset<T> masikHalmaz){
    ...
    public Multiset<T> different(Multiset<T> masikHalmaz){
        Multiset<T> different = new Multiset<>();
